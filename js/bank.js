...
var welcome_name = recent_data_fetched.recent_email.split("@")[0].toUpperCase();

if (recent_data) {
  var sign_up_bank = document.getElementById("sign_up_bank");

  sign_up_bank.innerText = "Welcome " + welcome_name;
...
function deposit_onclick() {
  if (!recent_data_fetched) {
    ...
    new_deposit_btn.addEventListener("click", () => {
      var user_amount_for_balance = document.getElementById("amount").value;
      ...
      if (recent_data_fetched.recent_password === user_password) {
        ...
        balance_amount =
          parseInt(balance_amount) + parseInt(user_amount_for_balance);
...
function withdraw_onclick() {
  if (!recent_data_fetched) {
    ...
    new_withdraw_btn.addEventListener("click", () => {
      ...
      //insufficent balance
      if (recent_data_fetched.balance_amount < user_amount_for_balance) {
        var deposit_box = document.getElementById("deposit_box");
...
function account_details_onclick() {
  if (!recent_data_fetched) {
    ...
    account_number.innerText =
      "Account Number : " + recent_data_fetched.account;
...
function balance_onclick() {
  if (!recent_data_fetched) {
    ...
    new_deposit_btn.addEventListener("click", () => {
      var user_amount = document.getElementById("amount").value;
      var user_account = document.getElementById(
